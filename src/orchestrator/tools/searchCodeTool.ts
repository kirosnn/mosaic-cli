...
export const searchCodeTool: Tool = {
  name: 'search_code',
  description: 'Search for a pattern in code files within the workspace using regex. Automatically ignores common build/dependency directories unless explicitly included. Use regex patterns for flexible searching (e.g., "function\\s+\\w+" to find function declarations).',
  parameters: [
    {
      name: 'pattern',
      type: 'string',
    ...
    },
    {
      name: 'directory',
      type: 'string',
      description: 'Directory to search in (must be within workspace)',
      required: false,
      default: '.'
    },
    {
